...
ERP_video = cbt.aDBS005.cbt_dates - cbt.aDBS005.cbt_dates(1);
...
saveas(f,[savedir,'erp-cal-plot.svg'])
saveas(f,[savedir,'erp-cal-plot.jpg'])
addpath(genpath('D:\Libraries\altmany-export_fig-v3.13-0-gd7671fe\altmany-export_fig-d7671fe\'))
