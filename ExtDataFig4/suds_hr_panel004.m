...
rune_data = readtable([loaddir,'\',date,'_CBT_SUDS_','aDBS004','.xlsx']);
...
frame_time = minutes(datetime(2020,9,18,10,38,20,'TimeZone','America/Chicago')-starttime);
...
img_name= [savedir,'suds_hr004.svg'];
saveas(fig,img_name);

img_name = [savedir,'suds_hr004.png'];
saveas(fig,img_name);